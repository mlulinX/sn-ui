...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/mlulinX/sn-ui/master/install.sh)
```
...
```sh
bash <(curl -Ls https://raw.githubusercontent.com/mlulinX/sn-ui/master/install.sh) 0.5.2
```

## Manual install & upgrade

1. First download the latest compressed package from https://github.com/mlulinX/sn-ui/releases, generally choose Architecture `amd64`
